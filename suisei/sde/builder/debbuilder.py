...
class DebBuilderConfig:

    """
    Utility class that contains the builder configuration of a deb
    builder.
    ...
    def __init__(self) -> None:
        ...
        """
        Creates a new DebBuilderConfig instance.
...
class DebBuilder(Builder):
    ...
    """
    Builder implementation that builds a Debian package.
